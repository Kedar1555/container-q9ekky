...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-q9ekky.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-q9ekky.containers.anotherwebservice.com/
...
```
git clone git@github.com:Kedar1555/container-q9ekky.git
cd container-q9ekky
```
...
```
docker attach container-q9ekky
```
